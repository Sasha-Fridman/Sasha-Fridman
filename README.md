...
|4  |[Games Platforms Success Prediction]()|Final project of the first module|🎮📈 Analyzing expert ratings, user reviews, platforms, genres, and historical sales data to forecast game success for an online global gaming store |python, pandas, scipy, matplotlib, seaborn, sidetable, regular expressions, math, sqaurify, functools|
||***2-nd module***||||
|5  |[Analysing users activity from Yandex.Afisha (event tickets marketplace) ]()|Business Analysis | 📆💸 Optimizing marketing expenses for the event and ticket marketplace by revealing insights on user behavior, purchase patterns, and revenue generation |python, pandas, numpy, matplotlib, seaborn, plotly express, sys|
|6  |[Conversion AB testing]()|Making Business Decisions Based on Data|🛒🧪 Boosting online store revenue through hypothesis prioritization, A/B test implementation and analysis |python, pandas, numpy, math, scipy, matplotlib, seaborn, datetime, plotly express|
|7  |[Research of the F&B establishments market in Los Angeles]()|Presentation of the results of the analytical study|🤖🍕 Analyzing open-source data on Los Angeles restaurants to secure investor interest in a robotic café venture by demonstrating sustainability beyond novelty (contains the study and its presentation)|python, pandas, numpy, matplotlib, seaborn, plotly express, regular expressions, usaddress, Canva|
